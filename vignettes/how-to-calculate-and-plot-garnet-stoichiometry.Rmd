...
```{r}
ggarnet_fe_mn()+
geom_point(data=GT,aes(x=Fe2O3+FeO+MnO,z=CaO,y=MgO,shape=mineral),size=4.5,alpha=0.5)

ggarnet_mn()+
geom_point(data=GT,aes(x=Fe2O3+FeO+MnO,y=CaO,z=MgO))

ggarnet_tourmaline()+
  geom_point(data=tur,aes(x=Fe2O3+FeO,y=Al2O3,z=MgO,shape=mineral),size=4.5,alpha=0.5)
